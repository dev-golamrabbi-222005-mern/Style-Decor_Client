    ...
    <div
      ...
      <div className="w-full max-w-xl my-10 p-8 md:p-10 rounded-3xl shadow-2xl bg-white/10 border border-white/20 relative z-10">
        ...
        <div className="relative z-10">
          ...
          <button
            type="button"
            className="py-2.5 px-4 rounded-xl w-full mb-3 bg-white/10 border border-white/20 text-white font-medium hover:bg-white/20 transition duration-300 flex items-center justify-center gap-2"
          >
